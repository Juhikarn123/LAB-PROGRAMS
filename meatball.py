...
Day’s quantity, how many grams of meatball is being sold    to every packet.

Array[ ]

Integer array

Array of integers, the weight of meatballs everyone came with.
...
def hire_meatball_artist():
    ...
    while len(queue) > 1:
        ...
        current_weight -= D
        if current_weight > 0:
            queue.append(current_weight)

    return arr.index(queue[0]) 

# Calling the function to test it
result = hire_meatball_artist()
print(result)
